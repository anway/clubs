...
$site_url	= www.hcs.harvard.edu/awk;
...
if($user){
	...
	$logoutUrl = $facebook->getLogoutUrl(array(
		'next'	=> 'www.hcs.harvard.edu/awk', // URL to redirect logged-out user
		));
}else{
	// Get login URL
	$loginUrl = $facebook->getLoginUrl(array(
		...
		'redirect_uri' => 'www.hcs.harvard.edu/awk', // URL to redirect logged-in user
		));
}
